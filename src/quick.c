...
--------------------------------------------------------------------------------- */
long long _median_search(STUDENT pmember[], unsigned char mode, long long left, long long right)
{
    long long mid = (left+right)/2;
    long long median = mid;
...
--------------------------------------------------------------------------------- */
long long _partition(STUDENT pmember[], unsigned char mode, long long left, long long right)
{
    long long low = left + 1;
    long long high = right;
    long long mid = _median_search(pmember,mode,left,right);
 ...
 *  - right : end index of partition
--------------------------------------------------------------------------------- */
void quick_sort(STUDENT pmember[], unsigned char mode,long long left, long long right)
{
    long long pivot;
    if(left <= right)
    {
        pivot =_partition(pmember, mode,left, right);
        quick_sort(pmember, mode, left, pivot-1);
        quick_sort(pmember, mode, pivot+1, right);
    }
}
